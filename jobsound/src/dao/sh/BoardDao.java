...
public class BoardDao {
	...
	public int boardUpdate(String b_num, String content, String title) {
		// TODO Auto-generated method stub
		Connection conn = null;	
		PreparedStatement pstmt= null;
		int result = 0;
		
		String sql = "UPDATE board SET content=?,title=?  where b_num=? and b_type=3";

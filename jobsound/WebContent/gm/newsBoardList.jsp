					...
					<c:forEach var="board" items="${list}">
						<tr>
							...
							<td class="text-start text-truncate" style="max-width: 400px">
								<a href="<%=context %>/gm/content.do?b_num=${board.b_num}&pageNum=${currentPage}&pageSize=${pageSize}&b_type=${board.b_type}" style="text-decoration: none;" class="btitle">${board.title} </a>
